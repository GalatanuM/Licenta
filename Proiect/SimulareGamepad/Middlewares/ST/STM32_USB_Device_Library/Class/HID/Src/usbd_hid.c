...
__ALIGN_BEGIN static uint8_t HID_MOUSE_ReportDesc[HID_MOUSE_REPORT_DESC_SIZE] __ALIGN_END =
{
  ...
  0x95, 0x01, // REPORT_COUNT (1 buttons)
  0x75, 0x01, // REPORT_SIZE (1 bit each)
  0x81, 0x02, // INPUT (Data, Variable, Absolute)
  0x95, 0x01, // REPORT_COUNT (padding)
  ...
  0x75, 0x08, // REPORT_SIZE (8 bits each)
  0x95, 0x01, // REPORT_COUNT (1 values)
  0x81, 0x02, // INPUT (Data, Variable, Relative)

  0xC0,       // END_COLLECTION (Physical)
  0x09, 0x3C, // USAGE (Vendor-defined)
  0x05, 0xFF, // USAGE_PAGE (Vendor-defined)
  0x09, 0x01, // USAGE (Vendor-defined)
  0x15, 0x00, // LOGICAL_MINIMUM (0)
  0x25, 0x01, // LOGICAL_MAXIMUM (1)
  0x75, 0x01, // REPORT_SIZE (1 bit)
  0x95, 0x02, // REPORT_COUNT (2 controls)
  0xB1, 0x22, // FEATURE (Data, Variable, Absolute)
  0x75, 0x06, // REPORT_SIZE (6 bits padding)
